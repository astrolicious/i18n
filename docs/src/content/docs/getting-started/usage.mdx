...
`astro-i18n` has a few required options:
...
1. Import the `<I18nClient />` component, likely in your layout:
    ...
    ---
    import I18nClient from "@astrolicious/astro-i18n/components/I18nClient.astro"
    ---
    <html>
    <head>
        <meta charset="utf-8" />
